...
jQuery.attach('.slider', (i, element) => {
	...
	function build() {
		...
		for (let i = 0; i < items.length; i++) {
			...
			let slide = jQuery('<div class="slider-slide swiper-slide"></div>')
	 ...
	 */
	function onPage(e) {
		swiper.slideTo(jQuery(e.target).index(), 750, false)
	}
	...
	let outer = jQuery('<div class="slider-outer"></div>')
	let inner = jQuery('<div class="slider-inner swiper-container"></div>')
