 ...
 * @since 1.0.0
 */
jQuery.fn.scrollAnimation = function () {
    ...
    function update() {
        ...
        offsetBot = bounds.top + bounds.height + jQuery(window).height()

        offsetTop = offsetTop - jQuery(window).height()
        offsetBot = offsetBot - jQuery(window).height()
    ...
    function render() {
        ...
        jQuery.each(propertyName, function (i, property) {
...
jQuery.attach('[data-scroll-animation]', function (i, element) {
