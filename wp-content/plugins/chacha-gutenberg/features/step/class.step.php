...
class CHACHA_STEP extends FEATURE {
    ...
    public function prefix_disable_gutenberg($current_status, $post_type){
        ...
        if ($post_type === 'step') return false;
    ...
    public function register_content_types() {
        ...
        register_post_type(
            'step', array(
                'label' => __('Steps', 'chacha-gutenberg'), // plural name
                'labels' => array(
                    'name' => __('Step', 'chacha-gutenberg'),
                    'singular_name' => __('Step', 'chacha-gutenberg'),
                    ...
                    'menu_name' => __('Steps', 'chacha-gutenberg'),
    ...
    public function register_roles(){
        ...
        foreach($roles as $the_role) {
            ...
            $role->add_cap( 'read_step');
            $role->add_cap( 'read_private_step' );
            $role->add_cap( 'edit_step' );
            $role->add_cap( 'edit_others_step' );
            $role->add_cap( 'edit_private_step' );
            $role->add_cap( 'edit_published_step' );
            $role->add_cap( 'publish_step' );
            $role->add_cap( 'delete_step');
            $role->add_cap( 'delete_others_step' );
            $role->add_cap( 'delete_private_step' );
            $role->add_cap( 'delete_published_step' );
        }
    }

    public function default_order($query) {
        // sort by release date
        if ($query->is_main_query() && $query->is_post_type_archive('step')) {
        }
    }
